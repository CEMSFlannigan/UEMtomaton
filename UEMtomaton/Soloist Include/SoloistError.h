...
#ifndef __Soloist_ERROR_H__
#define __Soloist_ERROR_H__
...
/// an Soloist system call.
///
/// \return The ErrorCode number of the last recorded error.
ErrorCode DLLENTRYDECLARATION SoloistGetLastError();

/// \brief Retrieves the last error that occurred
///
/// This function will retrieve the last error that was returned from
/// an Soloist system call, and convert it to a human-readable string message.
///
...
BOOL DLLENTRYDECLARATION SoloistGetLastErrorString(LPSTR errorString, DWORD bufferSizeInBytes);
...
BOOL DLLENTRYDECLARATION SoloistGetLastBuildResultCount(SoloistHandle handle, DWORD* count);
...
/// \return TRUE on success, FALSE if an error occurred. Call SoloistGetLastError() for more information.
BOOL DLLENTRYDECLARATION SoloistGetLastBuildResults(SoloistHandle handle, BuildResult* results, DWORD resultsCount);
...
/// \param[in] bufferSizeInBytes The allocated size of the errorString buffer, in bytes.
/// \return TRUE on success, FALSE if an error occurred. Call SoloistGetLastError() for more information.
BOOL DLLENTRYDECLARATION SoloistGetTaskErrorString(SoloistHandle handle, TASKID taskId, LPSTR errorString, DWORD bufferSizeInBytes);
