...
#ifndef __Soloist_PARAMETER_ID_H__
#define __Soloist_PARAMETER_ID_H__
...
typedef enum {
	...
	/// \brief The CamMaxNumPoints parameter
	PARAMETERID_CamMaxNumPoints = ( (0 << 24) | 101 ),
	/// \brief The CamRolloverEnable parameter
	PARAMETERID_CamRolloverEnable = ( (0 << 24) | 102 ),
	/// \brief The CamOutputMask parameter
	PARAMETERID_CamOutputMask = ( (0 << 24) | 103 ),
	/// \brief The CamOffset parameter
	PARAMETERID_CamOffset = ( (0 << 24) | 104 ),
	...
	/// \brief The ExternalCommandOffset parameter
	PARAMETERID_ExternalCommandOffset = ( (0 << 24) | 107 ),
	...
	/// \brief The TaskErrorAbortsAxis parameter
	PARAMETERID_TaskErrorAbortsAxis = ( (0 << 24) | 127 ),
	...
	/// \brief The AxisFaultTerminatesTask parameter
	PARAMETERID_AxisFaultTerminatesTask = ( (0 << 24) | 167 ),
	/// \brief The TaskStopAbortsAxis parameter
	PARAMETERID_TaskStopAbortsAxis = ( (0 << 24) | 168 ),
...
#endif // __Soloist_PARAMETER_ID_H__
